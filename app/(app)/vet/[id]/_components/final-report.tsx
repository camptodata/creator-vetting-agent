    ...
    <Card className="mt-6">
      ...
      <CardContent>
        ...
        <div className="flex items-start gap-2 text-xs text-muted-foreground">
          ...
          <p>
            <strong>Synthetic demo disclaimer:</strong> All data in this report is AI-generated
            from the creator handle alone. No real platform data was fetched. A production
            version would integrate Instagram/TikTok APIs, real engagement metrics, vector-similarity
            audience overlap analysis, and longitudinal growth signals.
          </p>
        </div>
      </CardContent>
    </Card>
